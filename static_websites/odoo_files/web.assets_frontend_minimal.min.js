...
document.addEventListener('DOMContentLoaded',async()=>{const header=document.querySelector('header#top');if(header){const topMenu=header.querySelector(".top_menu");if(header.classList.contains('o_no_autohide_menu')){topMenu&&topMenu.classList.remove('o_menu_loading');return;}
