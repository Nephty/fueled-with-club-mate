...
return i})),operationPromises:e}}function z(e,t,i){return(0,s.allSettled)([e.map((e=>{e.reject(i)
...
return}const s={id:a}
r.resolve({data:s})}))
return(0,s.all)(c)})).catch((e=>z(d,c,e))).then((()=>{}))}batchDelete(e,t,i){let r=i.url||this.buildURL(e,null,null,"deleteRecord")
...
return(0,s.allSettled)(o)})).catch((e=>z(n,o,e))).then((()=>{}))}createRecord(e,t,i){const r=e.serializerFor(i.modelName),a=i.adapterOptions||{}
...
s.resolve({data:l})}))
return(0,s.all)(n).then((()=>e))})).catch((e=>z(o,n,e))).then((e=>e))}deleteRecord(e,t,i){const r=i.adapterOptions||{}
...
null==e||e.reload()}}}throw e}isLogout(e){return"logout"===e}},E=(0,r.default)(T.prototype,"globalHttpHeaders",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),A=(0,r.default)(T.prototype,"cachePrefetch",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),z=(0,r.default)(T.prototype,"router",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),R=(0,r.default)(T.prototype,"fastboot",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),S=(0,r.default)(T.prototype,"fastbootBpr",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),U=(0,r.default)(T.prototype,"rum",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),T))||N)}))
...
e.default=void 0
var j,P,k,O,x,M,N,T,E,A,z,R,S,U,I,C,D,L,q,K,F,B,H,$,G,W,V,Q,Y,Z
...
function ie(e){if(!(0,y.hasBundle)("msg-overlay"))return!1
const t=e.to?e.to.name:null
for(let e=0;e<ee.length;e+=1){const i=ee[e],r=i instanceof RegExp&&i.test(t)
if(t===i||r)return!1}return!0}function re(e){const t=e.to?e.to.name:null
...
e.default=(j=(0,l.inject)("router"),P=(0,l.inject)("cache-prefetch@cache-prefetch"),k=(0,l.inject)("client-sensor-web@client-sensor"),O=(0,l.inject)("tracking"),x=(0,l.inject)("lix"),M=(0,l.inject)("prefetch"),N=(0,l.inject)("authentication@authenticated-user"),T=(0,l.inject)("global-nav-shared@nav-interaction"),E=(0,l.inject)("s-upsell@detached-upsell-modal"),A=(0,l.inject)("s-upsell@fullpage-takeover"),z=(0,l.inject)("coach-shared@onboarding"),R=(0,l.inject)("interop"),S=class extends n.default{get isCoachEnabled(){return!(0,v.isIsolatedBuild)()&&!this.coachIsDisabledForRoute}get showNav(){return this.navInteraction.globalNavIsVisible}get isGuest(){return this.authenticatedUser.isGuestUser}get guestUserHasMID(){return!!this.authenticatedUser.midToken}get outletClass(){return this.showNav?ae:oe}get isModalCurrentlyActive(){var e,t
...
return}}if(m.default&&ie(e)&&!this.isGuest){f.default.addMarker("mark_msg-overlay_overall_start")
...
this.route("hero",{path:"/"},(function(){this.route("calibration")
...
for(let a=0;a<t.length;++a){const n=t[a],s=J(e,n)
let l
if(i)if(s&&s in i){const e=0===n.indexOf(s)?n.substr(s.length+1):n
l=(0,o.get)(i[s],e)}else l=(0,o.get)(i,n)
r+=`::${n}:${l}`}return e+r.replace(Z,"-")}
e.default=void 0
var M,N,T,E,A,z,R,S,U,I,C,D,L,q,K,F,B,H,$,G,W,V
const Q=["authentication"]
let Y=e.default=(M=(0,s.inject)("router"),N=(0,s.inject)("authentication@authenticated-user"),T=(0,s.inject)("client-sensor-web@client-sensor"),E=(0,s.inject)("global-nav-shared@badge"),A=(0,s.inject)("global-nav-shared@nav-interaction"),z=(0,s.inject)("tracking"),R=(0,s.inject)("global-services@page-key-history"),S=(0,s.inject)("msg-overlay-manager@msg-overlay-manager"),U=(0,s.inject)("lix"),I=(0,s.inject)("interop"),(0,P.engineLix)(C=(0,_.default)(C=(D=class extends u.default{get isNileMynetworkEnabled(){return["enabled","mojo-nile"].includes(this.lix.getTreatment("voyager.web.mynetwork-sdui-entry-point"))}get isMojoNileMynetworkEnabled(){return"mojo-nile"===this.lix.getTreatment("voyager.web.mynetwork-sdui-entry-point")}get isNurtureEnabled(){return this.lix.getTreatmentIsEnabled("voyager.web.mynetwork-mojo-tabbed-experience")}get isDefaultToNurtureEnabled(){return this.lix.getTreatmentIsEnabled("voyager.web.mynetwork-mojo-nurture-primary")}get excludeNurtureBadgeCount(){return this.lix.getTreatmentIsEnabled("voyager.web.props-support-nurture-donut-badge")}shouldRedirectToNile(e){var t
const i=null===(t=e.to)||void 0===t?void 0:t.name
if(!this.isNileMynetworkEnabled)return!1
...
if("mynetwork.index.index"===i||"mynetwork.nurture.grow.index"===i)return{path:"/mynetwork",queryParams:{skipRedirect:!0,lipi:o}}
if(this.isMojoNileMynetworkEnabled&&"mynetwork.nurture.catch-up.index.index"===i){var n,s,l,u,d,c,p
return{path:`/mynetwork/catch-up/${(null===(n=e.to)||void 0===n||null===(s=n.parent)||void 0===s||null===(l=s.parent)||void 0===l||null===(u=l.params)||void 0===u?void 0:u.filter)||"all"}`,queryParams:{skipRedirect:!0,lipi:o,...(null===(d=e.to)||void 0===d||null===(c=d.parent)||void 0===c||null===(p=c.parent)||void 0===p?void 0:p.queryParams)||{}}}}return!1}constructor(){super(...arguments);(0,i.default)(this,"location",p.default.locationType);(0,i.default)(this,"rootURL",p.default.routerRootURL);(0,i.default)(this,"didRunBigPipeDegradationSensor",!1);(0,i.default)(this,"didRunAppBootSensor",!1);(0,t.default)(this,"router",L,this);(0,t.default)(this,"authenticatedUser",q,this);(0,t.default)(this,"clientSensor",K,this);(0,t.default)(this,"badgeService",F,this);(0,t.default)(this,"navInteraction",B,this);(0,t.default)(this,"tracking",H,this);(0,t.default)(this,"pageKeyHistory",$,this);(0,t.default)(this,"msgOverlayService",G,this);(0,t.default)(this,"lix",W,this);(0,t.default)(this,"interop",V,this);(0,w.setupRouteTracking)(this);(0,j.isDestroying)(this.router)||(0,l.setupRouter)(this.router)
this.on("routeDidChange",this.routeDidChange.bind(this))
this.on("routeWillChange",this.routeWillChange.bind(this))
new x.NileInterop(this.router,this.lix,this.navInteraction,this.tracking,this.interop,(e=>this.shouldRedirectToNile(e)),(e=>this.transitionToRedirectUrl(e))).setup()}routeDidChange(e){const t=this.tracking.getCurrentPageKey()
...
if(i.isGuestUser&&!i.shouldBypassAuth(e)&&(0,n.includesAnyTargetRoute)(Q,e.to))return i.redirectToLogin(e)
...
this.pageKeyHistory.clear()}},L=(0,r.default)(D.prototype,"router",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),q=(0,r.default)(D.prototype,"authenticatedUser",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),K=(0,r.default)(D.prototype,"clientSensor",[T],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),F=(0,r.default)(D.prototype,"badgeService",[E],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),B=(0,r.default)(D.prototype,"navInteraction",[A],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),H=(0,r.default)(D.prototype,"tracking",[z],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),$=(0,r.default)(D.prototype,"pageKeyHistory",[R],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),G=(0,r.default)(D.prototype,"msgOverlayService",[S],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),W=(0,r.default)(D.prototype,"lix",[U],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),V=(0,r.default)(D.prototype,"interop",[I],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),D))||C)||C)
const Z=/\./g
function J(e,t){const i=e.split(".")
let r=""
for(let e=0;e<i.length;e++){const a=i.slice(0,e+1).join(".")
if(0!==t.indexOf(a))break
r=a}return r}Y.map((function(){this.route("authentication",{path:"/",resetNamespace:!0},(function(){(0,v.isIsolatedBuild)()&&this.route("aide",{resetNamespace:!0})
...
document.addEventListener("artdeco-icons-loaded",se)
...
if(f.default){document.removeEventListener("artdeco-icons-loaded",se)
document.removeEventListener("DOMContentLoaded",ne)}}model(e,t){if((0,o.isDestroying)(this))return
const i={}
...
if(f.default&&t&&t!==this.oldFaviconVariant){Object.keys(ae).forEach((e=>{!function(e,t){if(f.default){const i=document.getElementById(`favicon-${e}`)
null==i||i.setAttribute("href",jSecure.sanitizeUrl(ae[e][t]))}}(e,t)}))
this.oldFaviconVariant=t}}setGlobalAlertVisibility(e){const t=this.controllerFor("application");(0,h.isQueryParamsOnly)(e)||(t.hasGlobalAlerts=oe(e))}routeWillChange(e){var t,i
if(null!=e&&e.to&&null!==(t=e.to)&&void 0!==t&&t.queryParams){const{queryParams:t}=e.to,i=t.trk,r=this.lix.getTreatmentIsEnabled("voyager.web.trust-challenge-toast"),a=this.i18n.lookupTranslation(j.default,"i18n_challenge_toast")
r&&"invitation_challenge_success"===i&&this.persistentToastManager.success({message:a})}if(!(e.isAborted||null===e.from||null!==(i=e.targetName)&&void 0!==i&&i.includes("loading"))){var r
this.persistentToastManager.hasToasts()&&!re.includes(null==e||null===(r=e.from)||void 0===r?void 0:r.name)&&this._clearToasts(e)}}routeDidChange(e){e.isAborted||this.setGlobalAlertVisibility(e)
...
return!0}loading(){return!this.fastbootBpr.isSSRPath}},K=(0,r.default)(q.prototype,"storeShim",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),F=(0,r.default)(q.prototype,"authenticatedUser",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),B=(0,r.default)(q.prototype,"forceLogout",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),H=(0,r.default)(q.prototype,"badgeService",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),$=(0,r.default)(q.prototype,"tracking",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),G=(0,r.default)(q.prototype,"lix",[T],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),W=(0,r.default)(q.prototype,"fastbootBpr",[E],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),V=(0,r.default)(q.prototype,"router",[A],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Q=(0,r.default)(q.prototype,"pemTracking",[z],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Y=(0,r.default)(q.prototype,"persistentToastManager",[R],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),Z=(0,r.default)(q.prototype,"tagManager",[S],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),J=(0,r.default)(q.prototype,"registerTagManager",[U],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),X=(0,r.default)(q.prototype,"i18n",[I],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),ee=(0,r.default)(q.prototype,"qualtricsSurvey",[C],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),te=(0,r.default)(q.prototype,"legoResolver",[D],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),ie=(0,r.default)(q.prototype,"legoTracking",[L],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),(0,r.default)(q.prototype,"didTransition",[c.action],Object.getOwnPropertyDescriptor(q.prototype,"didTransition"),q.prototype),(0,r.default)(q.prototype,"error",[c.action],Object.getOwnPropertyDescriptor(q.prototype,"error"),q.prototype),(0,r.default)(q.prototype,"loading",[c.action],Object.getOwnPropertyDescriptor(q.prototype,"loading"),q.prototype),q)}))
...
const e={msgOverlay:void 0,msgControlName:void 0,msgConversationId:void 0}
this.router.replaceWith("connect-services",{queryParams:{...e,session_redirect:`${(0,h.getDomainUrl)()}${this.router.currentURL}`}})}}))
...
return(0,m.hashSettled)(e).then((e=>{var t,i,r
if((0,o.isDestroying)(this))return
const{me:a,takeovers:n}=e
...
e!==v.httpStatus.S_403_FORBIDDEN||c.default.testing||!d.default||document.cookie?this.authenticatedUser.redirectToLogin():this.replaceWithExternal("/cookies-missing-error")}"rejected"===n.state&&this.jet.logError(n.reason,["takeover-error"],!1)
const s="fulfilled"===a.state?this.authenticatedUser.setAuthenticatedUser(a.value):void 0
d.default&&this.identityStore.reloadVersionTag()
const l="fulfilled"===n.state?n.value??{}:{},u=null===(t=l.elements)||void 0===t||null===(i=t[0])||void 0===i||null===(r=i.launchpadCards)||void 0===r?void 0:r[0],p="takeover__adConsentInfo__ad_consent_info_modal"===(null==u?void 0:u.cardType)?u:void 0
this.shouldTransitionToOnboarding=(null==u?void 0:u.cardType)===b.TAKEOVER_TYPE.ONBOARDING
this.shouldTransitionToAdConsentPage="takeover__adConsentInfo__ad_consent_info_page"===(null==u?void 0:u.cardType)
return{user:s,takeovers:l.elements,consentSplashModalData:p}}))}prepareMemberData(){const{storeShim:e}=this,t=e.findRecord("com.linkedin.voyager.common.Me",0,{adapterOptions:{url:`/${p.default.namespace}/me`}}),i=e.queryURL("voyagerLaunchpadDashLaunchpadViews",{adapterOptions:{degradations:[new g.default("voyager-launchpad-views","failed-fetching-launchpad-views",{productName:b.TAKEOVER_PEM_PRODUCT_NAME})],degradedEntityIDsToRemove:[]},reload:!0,params:{q:"context",launchpadContext:"TAKEOVER",recipe:"com.linkedin.voyager.dash.deco.launchpad.LaunchpadView"}})
...
e.default=void 0
var j,P,k,O,x,M,N,T,E,A,z,R,S,U,I
...
this.currentPageId=(0,p.default)()}static getMappedParametersFromRouteName(e){return c.ROUTE_TO_ASSET_PARAM_MAP[e]}},E=(0,r.default)(T.prototype,"router",[j],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),A=(0,r.default)(T.prototype,"assetLoader",[P],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),z=(0,r.default)(T.prototype,"storeShim",[k],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),R=(0,r.default)(T.prototype,"tracking",[O],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),S=(0,r.default)(T.prototype,"graphql",[x],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),U=(0,r.default)(T.prototype,"clientSensor",[M],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),I=(0,r.default)(T.prototype,"jet",[N],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),T)}))
...
e.default=void 0
e.default=(0,t.createTemplateFactory)({id:"HQhQkiiH",block:'[[[8,[39,0],null,[["@class","@illustration","@message","@headline"],["global-error","error-server",[28,[37,1],["error_page_description","voyager-web/templates/cookies-missing-error"],null],[28,[37,1],["error_page_headline","voyager-web/templates/cookies-missing-error"],null]]],null]],[],false,["artdeco-empty-state@artdeco-empty-state","t"]]',moduleName:"voyager-web/templates/cookies-missing-error.hbs",isStrictMode:!1})}))
...
return e.reverse()}return[]}function c(e){return!(e.length<=2)&&e[2]}function p(e){return"authentication.loading"===e}function f(e){return"jobs"===e||"jobs-search"===e||"job-details-engine"===e}e.NileInterop=(l=class{constructor(e,i,r,a,o,n,s){(0,t.default)(this,"verifiedOrigin",u,this)
this.router=e
this.lix=i
this.navInteraction=r
this.tracking=a
this.interopService=o
this.shouldRedirectToNile=n
this.transitionToRedirectUrl=s}setup(){if(o.default&&this.lix.getTreatmentIsEnabled("voyager.web.pai-web-nile-conflux")&&window.self!==window.top){this._setupMessageListener()
...
o.default&&this.lix.getTreatmentIsEnabled("voyager.web.pai-web-nile-conflux")&&window.self!==window.top&&(this.interopService.isActive=!0)}"navigate"===t&&i&&i.path&&i.type&&("back"===i.type?this.router.transitionTo(i.path).method(!1):this.router.transitionTo(i.path))}_sendMessageToNile(e,t){o.default&&window.parent.postMessage({type:e,detail:t},this.verifiedOrigin)}_setupModalObserver(){const e="artdeco-modal-outlet"
...
"undefined"==typeof FastBoot&&(runningTests||require("voyager-web/app").default.create({inferHueIconForArtDecoButtons:!0,locale:"en_US",rumConfig:{pageKeyPrefix:"d_","beacon-service":"tracking","event-name":"RealUserMonitoringEvent","enable-cdn-tracking":!0,"enable-pop-tracking":!0,"user-timing-mark-enabled":!0,"web-vitals-enabled":!0,"enable-memory-measurement":!0,"enable-pem-tracking-3":!0,"enable-tracking-3":!0},name:"voyager-web",version:"0.0.0-productspec+4d030506"}))
